...
#Has table with separate chaining
class Hashtable:
    ...
    def insert(self, key, value):
        ...
        if node is None:
            ...
            return
        #4. Iterate to the end of the linked lisst at provided index
        prev = node
    ...
    def remove(self, key):
        ...
        while node is not Node and node.key != key:
            prev = node
            node = node.next
